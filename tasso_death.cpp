...
//
    void show_instructions(Board const &board)
    {
        ...
        m_window.waitEvent(ev);
            ...
            sf::Text quest("   Welcome to our pandemic simulator!\nYour aim is to spread the most you can\n          and to destroy all humans! ", font);
    ...
    void click(Board &board)
    {
        ...
        {*/
        m_window.waitEvent(e);
        while (/*e.key.code != sf::Mouse::Left && */ e.key.code != sf::Keyboard::S)
        {
            //std::cout << 's' << '\n';
            m_window.waitEvent(e);
            //sf::Event::MouseButtonEvent::button=sf::Mouse::Button::Left;
